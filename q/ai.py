...
if __name__ == "__main__":
    text = "The capital of France is Paris. The capital of India is New Delhi. The capital of Australia is Canberra."
    count = 5
    print(get_generated_quiz(text, count))
    # print(generate_question(text, offset=5, count=5))